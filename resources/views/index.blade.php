        ...
        <div class="container">
            ...
            <div id="navbar" class="collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="http://marketplace.loc/categories">Категории</a>
                    </li>
                    ...
                    <div class="thumbnail">
                        ...
                        <div class="caption">
                            ...
                            <form action="https://internet-shop.tmweb.ru/basket/add/2" method="POST">
                                <button type="submit" class="btn btn-primary" role="button">В корзину</button>
                                <a href="https://internet-shop.tmweb.ru/mobiles/iphone_x_256" class="btn btn-default" role="button">Подробнее</a>
                                <input type="hidden" name="_token" value="0KxwZ7HpPxw3G7PiTxs34sxOEa3Yscv2l2EvcDYM">
                            </form>
                            </p>
                        </div>
                    ...
                    <div class="thumbnail">
                        ...
                        <div class="caption">
                            ...
                            <form action="https://internet-shop.tmweb.ru/basket/add/3" method="POST">
                                <button type="submit" class="btn btn-primary" role="button">В корзину</button>
                                <a href="https://internet-shop.tmweb.ru/mobiles/htc_one_s" class="btn btn-default" role="button">Подробнее</a>
                                <input type="hidden" name="_token" value="0KxwZ7HpPxw3G7PiTxs34sxOEa3Yscv2l2EvcDYM">
                            </form>
                            </p>
                        </div>
                    ...
                    <div class="thumbnail">
                        ...
                        <div class="caption">
                            ...
                            <form action="https://internet-shop.tmweb.ru/basket/add/5" method="POST">
                                <button type="submit" class="btn btn-primary" role="button">В корзину</button>
                                <a href="https://internet-shop.tmweb.ru/portable/beats_audio" class="btn btn-default" role="button">Подробнее</a>
                                <input type="hidden" name="_token" value="0KxwZ7HpPxw3G7PiTxs34sxOEa3Yscv2l2EvcDYM">
                            </form>
                            </p>
                        </div>
                    ...
                    <div class="thumbnail">
                        ...
                        <div class="caption">
                            ...
                            <form action="https://internet-shop.tmweb.ru/basket/add/6" method="POST">
                                <button type="submit" class="btn btn-primary" role="button">В корзину</button>
                                <a href="https://internet-shop.tmweb.ru/portable/gopro" class="btn btn-default" role="button">Подробнее</a>
                                <input type="hidden" name="_token" value="0KxwZ7HpPxw3G7PiTxs34sxOEa3Yscv2l2EvcDYM">
                            </form>
                            </p>
                        </div>
